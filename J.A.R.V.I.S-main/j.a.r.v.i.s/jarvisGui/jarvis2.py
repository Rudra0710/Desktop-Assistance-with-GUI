    ...
    def tasks(self):
        while True:
            ...
            if "open notepad" in self.query:
                ...
                pywhatkit.sendwhatmsg("+917016108463", "This is a testing message from Rudra", 10,00)
                ...
                if "yes" in query:
                    email = "12002040701140@mbit.edu.in"
                    password = "Rudra@0710"
                    send_to_email = to
                    ...
                    email = "diligentcrafter.working@gmail.com"
                    password = "Mr$ova21"
                    send_to_email = to
                    speak("And sir what about the message of the mail sir")
                    contentii = self.receivecommand().lower()
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("D:\J.A.R.V.I.S-main\j.a.r.v.i.s\jarvis\jarvis1.gif")
        self.ui.label.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("D:\J.A.R.V.I.S-main\j.a.r.v.i.s\jarvis\jarvis2.gif")
        self.ui.label_2.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("D:\J.A.R.V.I.S-main\j.a.r.v.i.s\jarvis\jarvis3.gif")
